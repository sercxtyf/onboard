...
import com.onboard.service.security.interceptors.EventCreatorRequired;

@Service("eventCreatorRequiredBean")
public class EventCreatorRequiredImpl extends BasicIdentifiableInterceptor implements EventCreatorRequired {
