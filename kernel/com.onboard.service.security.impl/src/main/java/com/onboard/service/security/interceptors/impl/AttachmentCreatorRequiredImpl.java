...
@Service("attachmentCreatorRequiredBean")
public class AttachmentCreatorRequiredImpl extends BasicIdentifiableInterceptor implements AttachmentCreatorRequired {
