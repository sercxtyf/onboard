...
@Service("projectCreationPrivilegeRequiredBean")
public class ProjectCreationPrivilegeRequiredImpl extends BasicIdentifiableInterceptor implements
        ProjectCreationPrivilegeRequired {
