...
public class TagAttachExample implements BaseExample {
    /**
     * This field was generated by MyBatis Generator.
     * This field corresponds to the database table tag_attach
     *
     ...
     * @mbggenerated Wed Aug 26 19:51:19 CST 2015
     */
    public TagAttachExample(TagAttachObject sample) {
        oredCriteria = new ArrayList<Criteria>();
        Criteria criteria = this.or();
        if (sample.getTagId() != null) {
            criteria.andTagIdEqualTo(sample.getTagId());
        }
     ...
     * This class corresponds to the database table tag_attach
     *
     * @mbggenerated Wed Aug 26 19:51:19 CST 2015
     */
