...
public class Attachment {
    ...
    public Attachment(Activity activity) {
        ...
        setAttachId(activity.getAttachId());
        setAttachType(activity.getAttachType());
        setCompanyId(activity.getCompanyId());
        setContentType("application/pdf");
        setId(activity.getAttachId());
        setName(activity.getTarget());
        setProjectId(activity.getProjectId());
        setTargetId(activity.getAttachId());
        setTargetType(activity.getAttachType());
    }
