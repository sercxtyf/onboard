...
/**
 * Created by XingLiang on 2015/5/14.
 */
// @RestController
public class ProxyController {
    ...
    @RequestMapping(value = { "/api/**", "plugins/**" }, method = RequestMethod.PUT)
    @ResponseBody
    ...
    @RequestMapping(value = { "/api/**", "plugins/**" }, method = RequestMethod.DELETE)
    @ResponseBody
